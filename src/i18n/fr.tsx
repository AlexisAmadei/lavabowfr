...
export const fr: Translations = {
  ...
  checkout: {
    title: 'Récapitulatif',
    summary: 'Articles',
    payCta: 'Payer avec Stripe',
    payingCta: 'Redirection…',
    backToCart: 'Retour au panier',
    errorOutOfStock: "Cet article n'est plus disponible.",
    errorInsufficientStock: (available) => `Il ne reste que ${available} unité${available > 1 ? 's' : ''} en stock.`,
  ...
  orderSuccess: {
    ...
    thanks: 'Votre paiement a bien été reçu. Vous allez recevoir un email de confirmation et la facture officielle de Stripe.',
    orderIdLabel: 'Numéro de commande',
    receiptNote: 'Le reçu Stripe et la facture PDF arrivent dans votre boîte mail.',
    pendingNote: 'Le paiement est en cours de validation. Cela peut prendre quelques secondes.',
