...
insert into section_videos (description, url, status)
values
    ('Video 1 Description', 'https://example.com/video1', 'active'),
    ('Video 2 Description', 'https://example.com/video2', 'inactive');
